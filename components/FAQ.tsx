...
const faqs = [
  [
    "What devices support Prime IPTV?",
    "Prime IPTV works with Smart TV, Android TV, Apple TV, Fire TV, Android, iPhone, iPad, Windows, Mac, MAG Box and compatible TV Box devices."
  ],
  [
    "How long does IPTV activation take?",
    "Activation begins after your order details are reviewed. You will receive confirmation and setup information through the contact details you provide."
  ],
  [
    "Can I use IPTV while travelling?",
    "Access may be possible from supported locations and compatible devices. Contact support before travelling if you need guidance for your setup."
  ],
  [
    "How do I install Prime IPTV?",
    "After your order is confirmed, you receive setup instructions adapted to the device selected in your order."
  ],
  [
    "What happens after I order an IPTV subscription?",
    "Our team reviews your information, contacts you to complete the order, and then sends your access and setup details."
  ],
  [
    "How can I contact Prime IPTV support?",
    "Use the WhatsApp or email options available in the contact section for assistance."
  ],
  [
    "Can I try Prime IPTV before subscribing?",
    "Yes. You can request a free 24-hour trial to test the service on a compatible device before choosing a subscription plan."
  ],
];
